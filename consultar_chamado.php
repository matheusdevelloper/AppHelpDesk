      ...
      <div class="row">
        ...
        <div class="card-consultar-chamado">
          <div class="card">
            ...
            <!-- Bloco imprimi os pedidos de chamadas -->
            ...
            <?php
              ...
              <div class="card mb-3 bg-light">
                <div class="card-body">
                  <h5 class="card-title"></br> <?= $chamado_dados[1]?></h5>
                  <h6 class="card-subtitle mb-2 text-muted"></br> <?= $chamado_dados[2]?></h6>
                  <p class="card-text"></br><?= $chamado_dados[3]?></p>
